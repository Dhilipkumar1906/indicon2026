        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
            ...
            >
              ...
              <ul className="space-y-4 text-gray-700 leading-relaxed">
                <li>• Papers must contain original and unpublished research work.</li>
                <li>• Manuscripts must not be under review or submitted to any other conference, journal, or publication venue.</li>
                <li>• IEEE anti-plagiarism policies apply to all submissions.</li>
                <li>• Authors are fully responsible for ensuring the originality and authenticity of their work.</li>
                <li>• Papers violating publication ethics may be rejected without review.</li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-4 text-gray-700 leading-relaxed">
                <li>• Papers must be prepared in IEEE standard two-column conference format.</li>
                <li>• Manuscripts must be written in English.</li>
                <li>• Papers should be between four and eight pages, including references and figures.</li>
                <li>• Literature-review-only papers are not accepted, and any submission exceeding eight pages will be rejected.</li>
                <li>
                  • Detailed format information is available on the IEEE website{" "}
                  <a
                ...
                <li>• Submissions exceeding the page limit may be rejected.</li>
              </ul>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <ul className="space-y-4 text-gray-700 leading-relaxed">
                  <li>• All papers must be submitted through the Microsoft Conference Management Toolkit (CMT).</li>
                  <li>• Submitting authors may need to create a CMT account before uploading. Authors should provide a complete paper title and abstract of no more than 250 words during submission.</li>
                  <li>• Abstracts should clearly summarize the contribution and significance of the work.</li>
                  <li>• Authors must verify all metadata before final submission.</li>
                  <li>• All submitted papers are peer-reviewed by the Technical Program Committee (TPC).</li>
                </ul>
              </div>

              <div>
                <ul className="space-y-4 text-gray-700 leading-relaxed">
                  <li>• All accepted papers that are registered and presented at the conference will be sent for possible inclusion in IEEE Xplore.</li>
                  <li>• Authors must agree to the IEEE copyright conditions and sign the IEEE copyright form as part of the online submission process.</li>
                  <li>• Accepted and presented papers will be considered for submission to IEEE Xplore.</li>
                  <li>• The Microsoft CMT service is used to manage the peer-review process for this conference.</li>
          ...
          <div
            className="mt-10 bg-[#FFF9E8] border border-[#F4D03F]/30 rounded-2xl p-6 transform transition-all duration-300 hover:shadow-md hover:border-[#F4D03F]/50 flex justify-center gap-4 mt-12 mb-12"
          >
          ...
          >
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <li>• <b>All manuscripts must be submitted through the submit button provided at the bottom of this document.</b></li>
              <li>• <b>All accepted and presented papers will be submitted for inclusion in IEEE Xplore, subject to meeting IEEE Xplore’s scope and quality requirements.</b></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <li>• All submitted manuscripts will be reviewed by the Program Committee.</li>
              ...
              <li>• The author list and order at the time of submission is considered final – no co-authors can be added or removed or re-ordered after the submission deadline or upon acceptance (no exceptions).</li>
              <li>• Submitted manuscripts that DO NOT follow these guidelines (i.e., do not meet the size, formatting, and anonymization requirements ) will be rejected without review.</li>
              <li>• Paper may be accepted for the track it is submitted in, or may be accepted as a WIP/Poster paper in case it does not meet the requisite depth. In case of the latter, authors will have 1 week to submit a shorter version of the paper to appear in the proceedings.</li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              <li>• Upon paper acceptance, at least one author must register for the conference and present the paper. Every accepted paper must have an individual author registration.</li>
              <li>• As per IEEE policy, authors of every published paper needs to sign a copyright transfer agreement. The instructions for the copyright agreement will be shared with the author after acceptance of the paper.</li>
              <li>• <b>All accepted and presented papers will be submitted for inclusion into IEEE Xplore, subject to meeting IEEE Xplore’s scope and quality requirements.</b></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed">
              <li>• IEEE is a trusted source for researchers in academia, industry, and government. By publishing with IEEE, you will get the global prestige that high-quality research deserves. All you need to know to publish in IEEE is <a href="https://ieeeauthorcenter.ieee.org/" className="text-blue-600 underline hover:text-blue-800">here</a>.</li>
              <ul className="list-circle pl-10 mt-4 space-y-3">
                <li>- <b>Become an IEEE Conference Author: IEEE offers guidance and best practices on the conference publishing process.</b> Refer <a href="https://conferences.ieeeauthorcenter.ieee.org/become-an-ieee-conference-author/" className="text-blue-600 underline hover:text-blue-800">here</a>.</li>
                <li>- <b>Author Ethics: Ethical guidelines are required in scientific publishing.</b> Refer <a href="https://conferences.ieeeauthorcenter.ieee.org/author-ethics/" className="text-blue-600 underline hover:text-blue-800">here</a>.</li>
                <li>- <b>Write your Paper:</b> Refer <a href="https://conferences.ieeeauthorcenter.ieee.org/write-your-paper/" className="text-blue-600 underline hover:text-blue-800">here</a>.</li>
                <li>- <b>Understand Peer Review:</b> Refer <a href="https://conferences.ieeeauthorcenter.ieee.org/understand-peer-review/" className="text-blue-600 underline hover:text-blue-800">here</a></li>
                <li>- <b>Get Published:</b> Refer <a href="https://conferences.ieeeauthorcenter.ieee.org/get-published/" className="text-blue-600 underline hover:text-blue-800">here</a>.</li>
              </ul>
            </ul>
          </motion.div>
          ...
          >
            ...
            <h2 className="mb-5 font-semibold text-gray-800">Authors are requested to upload the camera ready. Authors need to complete the following steps:</h2>

            <ul className="space-y-4 text-gray-700 leading-relaxed">
              <li>• All final paper submissions must be electronic, using IEEE Xplore compliant PDF format (*.pdf). Failure to do so may result in the rejection of the paper. Authors are requested to upload the camera ready in CMT</li>
              ...
              <li>• Length of manuscript should be maximum 8 pages</li>
              <li>• Format and verify your manuscript using IEEE PDF eXpress™ to generate IEEE Xplore®-compliant PDF. RESOURCES IEEE PDF eXpress: A freely available online tool designed to assist conference organizers and authors in complying with the IEEE PDF requirements <a href="https://www.ieee.org/conferences/publishing/pdfexpress.html" className="text-blue-600 underline hover:text-blue-800">https://www.ieee.org/conferences/publishing/pdfexpress.html</a> (In case, you need conference id to use PDFXpress, please use this – #72446)</li>
              <li>• Get and upload your IEEE Electronic Copyright Form (eCF) to CMT.</li>
              <li>• Upload your camera-ready paper (IEEE Xplore®-compliant PDF or Microsoft Word Document) to CMT, your respective track.</li>
              <li>• Register for the conference with payment. Registration should be done before camera ready upload.</li>
            </ul>
          </motion.div>
      ...
      {showSubmitPopup && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-[#4A0012] mb-3">
              Submissions Closed
            </h2>

            <p className="text-gray-600 leading-relaxed mb-8">
              The paper submission window for IEEE INDICON 2026 officially closed on <b>August 31, 2026</b>. Thank you to all the authors for your overwhelming response!
            </p>
