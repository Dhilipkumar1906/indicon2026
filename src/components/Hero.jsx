    ...
    >
      <div className="max-w-5xl mx-auto text-center px-6 pt-30 ">
        ...
        <h1 className="mt-2 text-5xl md:text-7xl font-bold text-white font-['Playfair_Display'] fade-up">
          <p>IEEE</p>
          <span className="text-[#F4D03F] drop-shadow-lg">INDICON 2026</span>
        </h1>

        <p className="mt-8 text-lg md:text-2xl text-white/90 leading-relaxed font-['Cinzel']">
          Net-Zero Cyber-Physical Intelligence: AI, 6G & Sustainable Electronics
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <button
            onClick={() => {
              window.scrollTo(0, 0);
              navigate("/registration"); // Navigates to the Registration page
            }}
            className="bg-[#F4D03F] text-[#4A0012] px-8 py-4 rounded-full font-semibold hover:scale-105 transition"
          >
            Register Now
          </button>
          ...
          <button
            onClick={() => {
              window.scrollTo(0, 0);
              navigate("/guidelines"); // Navigates to Guidelines page
            }}
        ...
        <div className="mt-3 flex justify-center animate-fadeInUp"></div>
      </div>
    </section>
  );
}